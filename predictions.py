...
def predictor(home_team, away_team):
	...
	predictions = {'Home Team Winning Probability': round(HTWP*100,2), 'Draw Probability': round(DP*100,2), 'Away Team Winning Probability': round(ATWP*100,2), 
	'Predicted Score 1': PS1, 'Predicted Score 2': PS2, 'Predicted Score 3': PS3, 
	'Home Team Betting Odds': round(HTBO,2), 'Draw Betting Odds': round(DBO,2), 'Away Team Betting Odds': round(ATBO,2) }
